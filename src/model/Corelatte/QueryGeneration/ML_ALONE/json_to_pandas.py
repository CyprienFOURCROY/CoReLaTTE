...
def validate_plan(query_plan: dict | RelationshipPlan | ClusteringPlan):
    if isinstance(query_plan, (RelationshipPlan, ClusteringPlan)):
        return query_plan
...
def compile_ml_plan(query_plan: dict | RelationshipPlan | ClusteringPlan) -> str:
    plan = validate_plan(query_plan)
